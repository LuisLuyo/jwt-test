...
CREATE TABLE SIGV_MAESTRO.OPERACION(
...
CREATE TABLE SIGV_SEGURIDAD.TERMINAL(
...
CREATE TABLE SIGV_SEGURIDAD.SETTING(
...
INSERT INTO SIGV_SEGURIDAD.SETTING (IDEMPRESA, CODIGO, DESCRIPCION, CANTLOGEO, CADUCIDAD, ALERTACADUCIDAD, CLAVEUSUARIONUEVO) VALUES(1,'GLOBAL-001','CONFIGURACION INICIAL',3,30,3,1::BIT);
...
CREATE TABLE SIGV_SEGURIDAD.LOG(
...
CREATE TABLE SIGV_VENTAS.EMPRESASUCURSAL(
