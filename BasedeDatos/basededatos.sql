...
CREATE USER adminfrances1720 with password 'Frances1720@2020'; /* CREA ROL */

CREATE SCHEMA IF NOT EXISTS SIGV_SEGURIDAD AUTHORIZATION adminfrances1720; /* ASIGNA ESQUEMA A ROL CREADO */
...
INSERT INTO SIGV_SEGURIDAD.USUARIO (USUARIO, CLAVE, IDPERFIL, IDCOLABORADOR, ESTADO, IDSUCURSAL, ONLINE, PCKGSMS, IDUSUARIOALTA, CANALALTA, FECHAALTA) VALUES ('JFABRIZIO','JFABRIZIO',2,2,'G',1,1,0,1,'QUERY',NOW());
...
CREATE SCHEMA IF NOT EXISTS SIGV_PERSONA AUTHORIZATION adminfrances1720; /* ASIGNA ESQUEMA A ROL CREADO */
...
INSERT INTO SIGV_PERSONA.COLABORADOR (IDSUCURSAL, APELLIDOPATERNO, APELLIDOMATERNO, NOMBRES, IDTIPODOCUMENTO, NUMDOCUMENTO, RUC, FECHANACIMIENTO, SEXO, ESTADO, IDUSUARIOALTA, CANALALTA, FECHAALTA) VALUES(1,'LUYO','HERNANDEZ','JEAN PAUL',1,'74309370','0','1994-11-20','M','G',1,'QUERY',NOW());

INSERT INTO SIGV_PERSONA.COLABORADOR (IDSUCURSAL, APELLIDOPATERNO, APELLIDOMATERNO, NOMBRES, IDTIPODOCUMENTO, NUMDOCUMENTO, RUC, FECHANACIMIENTO, SEXO, ESTADO, IDUSUARIOALTA, CANALALTA, FECHAALTA) VALUES(1,'VICENTE','HERNANDEZ','FABRIZIO',1,'74309370','0','2004-07-01','M','G',1,'QUERY',NOW());
